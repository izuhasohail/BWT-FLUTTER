      ...
      body: Column(
        children: [
          Expanded(child: Container(
           ...
           // color: Colors.red,
            child: Column(
              mainAxisAlignment: MainAxisAlignment.end,//vertical axis
              crossAxisAlignment: CrossAxisAlignment.end,//horizontal axis
              children:  [
              Text(
                hideInput ? '' : input,
                style: TextStyle(
          ...
          Row(
            children: [
              ...
              button(
                text:"<",buttonBgColor: operatorColor ,
                tColor: orangeColor
              ),
               button(
                 text:"%",buttonBgColor: operatorColor,
          ...
          Row(
            children: [
              ...
              button(
                text:"x", buttonBgColor: operatorColor,
                tColor: orangeColor
              ),
